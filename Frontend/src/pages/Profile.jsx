  ...
  return (
    <>
      <div className="bg-[#e5e5e5]">
        <div className="max-w-7xl mx-auto flex flex-wrap gap-9 px-2 py-2 text-sm font-medium">
          {
            tabs.map((tab) => (
                <button key={tab}
      ...
      <div className="min-h-screen py-10 px-4 bg-gray-100">
        <div className="max-w-6xl mx-auto">
          ...
          {activeTab === "Profile" && (
            <>
              {/* Headers */}
             <div className="bg-gradient-to-r from-gray-800 to-[#f74565] rounded-t-md 
              px-6 py-6 flex items-center gap-6 text-white">
                <div className="relative w-20 h-20 border-4 border-white rounded-full flex 
                items-center justify-center bg-white text-gray-600">
                  <IoMdAdd size={24} />
                </div>
                <div className="mt-2">
                  <h2 className="text-2xl font-bold">Hi, Jaydip </h2>
              ...
              <div className="bg-white px-6 py-6 rounded-b-md">
                ...
                <div className="mb-3 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <span>jaydipkadam732@gmail.com</span>
